...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
	    ...
	    lblNewLabel_1.setBounds(86, 10, 356, 42);
	    ...
	    labelFecha.setBounds(10, 85, 294, 36);
	    ...
	    JLabel labelDescripcion = new JLabel("<html><body>Sistema de reservas del hotel. Administre de forma óptima y fácil <br> las reservas y huespedes del hotel   </body></html>");
	    labelDescripcion.setForeground(SystemColor.textHighlightText);
	    ...
	    JLabel labelDescripcion_1 = new JLabel("<html><body> Esta herramienta le permitirá llevar un control completo y detallado de sus reservas y huéspedes, tendrá acceso a heramientas especializadas para tareas como lo son:</body></html>");
	    labelDescripcion_1.setForeground(SystemColor.textHighlightText);
	    ...
	    lblNewLabel_3_1.setForeground(SystemColor.textHighlightText);
	    ...
	    lblNewLabel_3_2.setForeground(SystemColor.textHighlightText);

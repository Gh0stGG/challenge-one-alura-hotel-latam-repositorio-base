...
public class Login extends JFrame {
	...
	public Login() {
		...
		txtUsuario.setBackground(SystemColor.controlDkShadow);
		...
		labelTitulo.setForeground(SystemColor.textHighlightText);
		labelTitulo.setFont(new Font("Roboto Black", Font.PLAIN, 26));
		labelTitulo.setBounds(75, 156, 252, 41);
		...
		txtContrasena.setBackground(SystemColor.controlDkShadow);
		txtContrasena.setText("********");
		...
		LabelUsuario.setForeground(SystemColor.textHighlightText);
		LabelUsuario.setFont(new Font("Roboto Black", Font.PLAIN, 20));
		LabelUsuario.setBounds(65, 219, 172, 26);
		panel.add(LabelUsuario);
		
		JLabel lblContrasea = new JLabel("Contraseña");
		lblContrasea.setForeground(SystemColor.textHighlightText);
		...
		lblNewLabel_1.setBounds(65, 46, 100, 100);
	...
	//obtiene el valor ingresado en los campos usuario y contraseña
